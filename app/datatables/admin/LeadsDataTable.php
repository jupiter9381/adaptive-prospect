...
class LeadsDataTable extends BaseDataTable
{
        ...
        return datatables()
            ...
            ->addColumn('action', function ($row) {
                ...
                if ($row->client_id == null || $row->client_id == '') {
                    ...
                    $follow .= '<li onclick="addContact(' . $row->id . ')"><a href="javascript:;"><i class="fa fa-calendar"></i> ' . __('Add Contact') . '</a></li>';
                } else {
                    $follow = '';
                }
                ...
                <ul role="menu" class="dropdown-menu pull-right">
                    ...
                    <li><a href="javascript:;" class="sa-params" data-user-id="' . $row->id . '"><i class="fa fa-trash "></i> ' . __('app.delete') . '</a></li>
                     ' . $follow . '   
                     <li><a href="' . route('admin.leads.sms-portal', $row->id) . '"><i class="fa fa-edit"></i> Contact Center </a></li>
                </ul>   
              </div>';
                return $action;
            })
            ...
            ->editColumn('client_name', function ($row) {
                if ($row->client_id != null && $row->client_id != '') {
                    $label = '<label class="badge badge-success" style="width: 75px;">' . __('app.client') . '</label>';
                } else {
                    $label = '<label class="badge badge-primary" style="width: 75px;">' . __('app.lead') . '</label>';
                }
            ...
            ->rawColumns(['status', 'action', 'client_name', 'next_follow_up_date', 'contact_date']);
    }
    ...
    protected function getColumns()
    {
        ...
        //    '#' => ['data' => 'id', 'name' => 'id', 'visible' => true],
            __('app.lead') => ['data' => 'client_name', 'name' => 'client_name'],
            ...
            __('Contact Date') => ['data' => 'contact_date', 'name' => 'contact_date'],
